...
public class UserSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (userService.getAll().isEmpty()) {
            ...
            user1.setEmail("alicejohnson@gmail.com");
            ...
            user3.setEmail("charliebrown@gmail.com");
            ...
            user4.setEmail("dianaprince@gmail.com");
            ...
            user5.setEmail("ethanhunt@gmail.com");
            ...
            user6.setEmail("camilogutierrez@gmail.com");
