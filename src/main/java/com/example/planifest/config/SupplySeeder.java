...
@Component
/* PD: Este order indica cual sera el orden en el que se van a "Activar Los Seeders" por asi decirlo */
/* Ya que sin Suministros no se puede crear un evento  Activar cuando sea nesesario y se ordene las prioridades*/
/*@Order(1) */
...
/* En caso de que No Existan Suministros creador se insertan estos si estos no  estan */
        if(supplyService.getAll().isEmpty()){
            ...
            supply1.setDescription("Advertencia: Use todos los Globos que estan el Paquete, Lo guarde los Paquetes si no estan Todos los Globos");
            ...
            supply2.setDescription("Solo usar estas pulseras en eventos Nocturnos, de cualquier tipo para una mejor experiencia Nt(Se cuenta cada pulsera)");
            ...
            supply3.setDescription("Precaucion: Uso de las fuentes de agua SOLO en eventos donde haya prescencia de Adultos y no eventos que tengan ningun tipo de menor de edad");
